...
<section class="article">
    <div class="article_cont">
        ...
        <div>
            <p style="float: left; font-size: 0.4rem; line-height: 1rem; height: 1rem; padding-right: 0.3rem;padding-top: .15rem;">马上分享: </p>
            <div style="float: left;padding-top: 0.2rem; height: 1rem; line-height: 1rem;">
                ...
                <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"1","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["sqq","qzone","tsina","tqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["sqq","qzone","tsina","tqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            </div>
