...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='后台管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_admin` VALUES (13,'admin','619cf3d2691c11af59f5d3b811440302','XrBvf41',1,0,NULL,1,1,'',1480430167,1481551133,NULL),(14,'admin1','f148530db152d058f72e9e96a2b6925b','WYFqnM',2,0,NULL,1,1,'',1480430167,1480430927,NULL);
...
CREATE TABLE `t_admin_role` (
  ...
  `Frole_name` varchar(20) DEFAULT NULL COMMENT '角色名称',
  `Fdesc` varchar(100) DEFAULT '' COMMENT '角色说明',
  `Fis_manage` tinyint(1) unsigned DEFAULT '1' COMMENT '管理：1管理中心，0商户中心',
  `Fstatus` tinyint(1) unsigned DEFAULT '1' COMMENT '状态 1:启用 2:停用',
  `Fremark` varchar(60) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`Frole_id`)
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_admin_role_perm`
--

DROP TABLE IF EXISTS `t_admin_role_perm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_admin_role_perm` (
  `Fid` int(11) NOT NULL,
  `Frole_id` int(11) unsigned NOT NULL COMMENT '角色id',
  `Fperm_id` int(11) unsigned NOT NULL COMMENT '权限id',
  PRIMARY KEY (`Fid`),
  KEY `role_id` (`Frole_id`,`Fperm_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='角色权限表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_admin_role_perm`
--

LOCK TABLES `t_admin_role_perm` WRITE;
/*!40000 ALTER TABLE `t_admin_role_perm` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_admin_role_perm` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `t_user` (
  ...
  `Flog_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '登录类型0：普通，1：微信，2：QQ',
...
INSERT INTO `t_user_detail` VALUES (3,'nick1','Cren',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,1480342136,1480342819,NULL),(6,'hello','Cren',1,'441234123412341234',1,'649460214@qq.com','13631255371',NULL,'1',NULL,'3',0,'/files/img/201612/663bf90c6cb32d6d23e7aea04dc1e001.jpg','http://www.dev.huzhu.com/files/img/201701/3079e4ce9d6203379a47ad91721a5283.jpeg',NULL,1484139515,NULL),(10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,1481943323,1481943323,NULL),(12,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,1481943320,1481943320,NULL),(14,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,1481943281,1481943281,NULL),(15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,1481943313,1481943313,NULL),(16,'1234321','432123',1,'432123432',1,'','','','','','',1,'',NULL,1481939326,1481939326,''),(17,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,1481944405,1481944405,NULL),(21,',,','12345',0,'',1,'','','','','','',0,'','',1482064480,1482064480,''),(25,'12345','123',0,'',1,'','','','','','',1,'','',1481944490,1482064466,''),(26,'q4123','12132312',2,'1234567890-34567890',1,'','','','','','',0,'/files/img/201612/7dcb71a5791f90c591a145d3867785ab.jpeg','/files/img/201612/b7c7d77ace905edfb498e611a463c3d1.jpg',NULL,1481945445,'65432543265432'),(35,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,1484150469,1484150469,NULL),(36,'Cren',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'http://wx.qlogo.cn/mmopen/vMUEcG7d3MkloaLWAe6x6MfV89OkCjENAK5qicsqjDuxtsXdJ4rXYnXTFylYjrB50OxYdibaL1SIGftqyy7b5IYibwMMJicjibx6Y/0',NULL,NULL,0,NULL),(37,'Cren',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'http://wx.qlogo.cn/mmopen/vMUEcG7d3MkloaLWAe6x6MfV89OkCjENAK5qicsqjDuxtsXdJ4rXYnXTFylYjrB50OxYdibaL1SIGftqyy7b5IYibwMMJicjibx6Y/0',NULL,NULL,0,NULL);
...
-- Dump completed on 2017-01-14 22:19:25
