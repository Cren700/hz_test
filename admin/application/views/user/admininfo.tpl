                            ...
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                        ...
                                        <label class="span2" style="display: inline; margin-left:0" for="<{$r['Frole_id']}>"><input id="<{$r['Frole_id']}>" type="radio" name="role_id" value="<{$r['Frole_id']}>" <{if $r['Frole_id'] eq $user['Frole_id']}>checked="checked"<{/if}>><{$r['Frole_name']}></label>
                                        <{/foreach}>
                                    </div>
                                </div>
                            </div>
