                        ...
                        <div class="widget-content nopadding">
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="post_title" placeholder="标题" value="<{$posts['Fpost_title']|default:''}>">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="post_author" placeholder="作者" value="<{$posts['Fpost_author']|default:''}>">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="post_keyword" placeholder="关键词（多个关键词以'、'分割）" value="<{$posts['Fpost_keyword']|default:''}>">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span4" name="post_excerpt" placeholder="摘要" value="<{$posts['Fpost_excerpt']|default:''}>">
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <div class="span12">
                                    ...
                                    <div class="controls" style="vertical-align: middle">
                                        ...
                                        <input type="radio" style="margin: 0" class="span1" value="1" name="comment_status" <{if isset($posts['Fcomment_status']) && $posts['Fcomment_status'] eq 1}>checked<{elseif !isset($posts['Fcomment_status'])}>checked<{/if}> />
                                        <label style="display: inline-block">禁止</label>
                                        <input type="radio" style="margin: 0" class="span1" value="0" name="comment_status" <{if isset($posts['Fcomment_status']) && $posts['Fcomment_status'] eq 0}>checked<{/if}>>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
